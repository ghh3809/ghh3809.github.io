...
| 字段名称 | 说明                                                         | 示例                                                   |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------ |
| 卡池ID   | 当前卡池的唯一ID，**不可重复**。一般来说角色up池从100开始，武器up池从200开始，当前序号可参考[当前卡池信息](https://github.com/ghh3809/kotoumi/blob/main/script/genshin_data.sql)。**这个字段很重要，后续还会用到** | 105<br>204                                             |
...
| 字段名称 | 说明                                                         | 示例                 |
| -------- | ------------------------------------------------------------ | -------------------- |
| 对象ID   | 该角色/武器的唯一ID，**不可重复**。一般来说角色从1000开始，武器从2000开始，当前序号可参考[当前卡池信息](https://github.com/ghh3809/kotoumi/blob/main/script/genshin_data.sql)。**这个字段很重要，后续还会用到** | 1030<br>2059         |
| 对象类型 | 表示是一个角色还是武器。1表示角色，2表示武器                 | 1<br>2               |
...
-- 角色up池，注意到卡池名已经被我改掉，方便区分，实际编写的时候统一叫做“角色up”
...
insert into kotoumi_genshin_wish_event values (105, '角色up-公子', 'up角色：达达利亚，非up角色：常驻池五星角色', 'up角色：罗莎莉亚、芭芭拉、菲谢尔，非up角色：常驻池四星', 3, '2021-04-06 18:00:00', '2021-04-27 14:59:59');

-- 武器up池，注意到卡池名已经被我改掉，方便区分，实际编写的时候统一叫做“武器up”
...
insert into kotoumi_genshin_wish_event values (204, '武器up-天空之翼&四风原典', 'up武器：天空之翼、四风原典，非up武器：常驻池五星武器', 'up武器：暗巷猎手、西风剑、祭礼大剑、西风秘典、西风长枪，非up武器：常驻池四星', 2, '2021-04-06 18:00:00', '2021-04-27 14:59:59');
```
